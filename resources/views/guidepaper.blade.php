...
<div style="margin-top: 200px" class="container1">
    ...
    <div class="row" style="margin-top: 20px;">
        <div class="col-md-12">
            ...
            <p>This is a competition that tests participants' ability to write scientific papers. The paper itself is a writing that discusses a particular topic supported by strong data and arguments. Paper can also be interpreted as a summary of a research conducted. In this competition we also incorporated a poster competition. Where participants who have made a paper will also apply it in a poster for display. Later there will be best paper & best poster get cash money of $50 through Paypal transactions.</p>
            <h3>Main theme for paper competition:</h3>
            <p><strong>Applied Business Science</strong></p>

            <h3>General requirements</h3>
            <ul>
                <li>Participants are active undergraduate students (Diploma and Bachelor) from all majors, public or private universities, and proven by active student card.</li>
                ...
                <li>There is a registration fee for participants who register for the Paper Competition which is $5 (Rp 76.000).</li>
                ...
                <li>Papers and posters that are contested are the original work of the participants and have never been included or published.</li>
                <li>If in the future there is a copyright lawsuit, the committee is not responsible for this, the committee will assume that all designs included are the original work of the participants.</li>
            </ul>
            ...
            <ul>
                ...
                <li>Margin rules: 4 cm from the left side, 3 cm from the right side, 4 cm from the top border, and 3 cm from the bottom border.</li>
                <li>The title of the paper is typed in capital letters and bold in the center without underlining.</li>
            ...
            <div class="mb-3">
                <label for="formFile" class="form-label">Upload Full Paper:</label>
    ...
    <div class="row" style="margin-top: 50px;">
        <div class="col-md-12">
            ...
            <p>The poster competition is designed to provide an alternative to oral presentations for paper submissions. Participants will create visual representations of their research to be displayed at the conference. This format allows for a more concise and impactful presentation of findings. By condensing their findings into a concise and informative graphic, participants can effectively communicate their key points to a wide audience. The poster competition offers a unique opportunity for researchers to explore creative ways to present their work and receive valuable feedback.</p>

            <h3>General requirements</h3>
            <ul>
                <li>The decision of the jury is absolute and inviolable.</li>
                <li>Scientific posters are the result of original research that has never been published before in any media and has never been included in a similar competition.</li>
                <li>If there is evidence of a violation, the work will be disqualified or cancelled.</li>
                <li>The committee has the right and authority to publish scientific posters while still stating the author's name.</li>
                <li>Technical and visualisation styles are free, original, and do not use elements that violate copyright and ethics.</li>
            ...
            <ul>
                ...
                <li>Background, containing the appointment of the problem studied, an explanation of the importance and attractiveness of the work.</li>
                <li>Objective.</li>
                <li>Methods.</li>
